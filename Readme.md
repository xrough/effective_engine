...
**Result (90-day sweep, $\text{move\_pct} \in \{10\%, 20\%, 30\%\}$):** 0/42 PASS at $10\%$ or $20\%$. At $30\%$, 6/42 PASS (5-min bars only). No broad active-vs-quiet separation survives. **Verdict: WEAK.** The Gate 4 $\mathrm{bf25}$ gain is mostly unconditional, with only a narrow regime-specific pocket.
